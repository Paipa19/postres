                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-10">
                                        ...
                                        <p class="text-muted"><?= $DataProducto->getNombre() . ": " . $DataProducto->getNombre() ?></p>
                                        <hr>

                                        <hr>
                                        <strong><i class="fas fa-phone mr-1"></i> Valor Unitario</strong>
                                        <p class="text-muted"><?= $DataProducto->getValorUnitario() ?></p>
                                        <hr>
                                        <p>
                                        <hr>
                                        <strong><i class="fas fa-phone mr-1"></i> Estado</strong>
                                        <p
                                            class="text-muted"><?= $DataProducto->getEstadoProducto() ?></p>
                                        <p>
                                        <hr>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $DataProducto->getIdProducto(); ?>"
