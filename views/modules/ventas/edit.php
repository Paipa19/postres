                                            ...
                                            <input id="idVenta" name="idVenta" value="<?= $DataVenta->getIdVenta(); ?>" hidden
                                                   required="required" type="text">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="text" class="form-control" id="costoDomicilio"
                                                                   name="costoDomicilio" value="<?= $DataVenta->getCostoDomicilio(); ?>"
                                                                   placeholder="Ingrese costo domicilio">
                                                        </div>
                                                    </div>
